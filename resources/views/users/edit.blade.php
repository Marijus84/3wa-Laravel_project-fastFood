            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <input id="password" type="hidden" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value = "{{old('password',$user->password)}}" >
                        ...
                        <input id="password-confirm" type="hidden" class="form-control" name="password_confirmation" value = "{{old('password',$user->password)}}" >
